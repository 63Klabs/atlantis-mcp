...
- [x] 1. Set up Indexer Lambda project structure and core utilities
  - [x] 1.1 Create project scaffold at `application-infrastructure/src/lambda/indexer/`
  ...
  - [x] 1.5 Write property test for file filter (Property 2)
    - **Property 2: File filtering correctness**
    - File: `tests/property/file-filter.property.test.js`
    - **Validates: Requirements 6.1, 6.2, 6.3, 6.4**

- [x] 2. Checkpoint — Verify core utilities
  - Ensure all tests pass, ask the user if questions arise.

- [x] 3. Implement content extractors
  - [x] 3.1 Implement `lib/extractors/markdown.js`
  ...
  - [x] 3.6 Write property test for Python extractor (Property 5)
  ...
  - [x] 3.7 Implement `lib/extractors/cloudformation.js`
  ...
  - [x] 3.8 Write property test for CloudFormation extractor (Property 6)
...
- [x] 4. Checkpoint — Verify extractors
  - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Implement GitHub client and archive processor
  - [x] 5.1 Implement `lib/github-client.js`
  ...
  - [x] 5.2 Write property tests for GitHub client rate limiting (Properties 17, 18)
  ...
  - [x] 5.3 Implement `lib/archive-processor.js`
    - `extractArchive(buffer)` — extract zip archive in memory using `adm-zip`, return array of `{path, content}` entries
    - _Requirements: 5.4_

  - [x] 5.4 Write property test for archive download selection (Property 14)
  ...
  - [x] 5.5 Write property tests for org parsing and brown-out resilience (Properties 15, 16)
...
- [x] 6. Implement DynamoDB writer and main index builder
  - [x] 6.1 Implement `lib/dynamo-writer.js`
  ...
  - [x] 6.2 Write property tests for DynamoDB key format and main index (Properties 7, 8, 9, 10)
  ...
  - [x] 6.3 Implement `lib/index-builder.js` — orchestrator
  ...
  - [x] 6.4 Write property tests for relevance scoring and version failure safety (Properties 11, 12, 13)
...
- [x] 7. Implement Lambda handler entry point
  - [x] 7.1 Implement `index.js` — Lambda handler
...
- [x] 8. Checkpoint — Verify indexer Lambda code
  - Ensure all tests pass, ask the user if questions arise.

- [x] 9. Add infrastructure resources to template.yml
  - [x] 9.1 Add DocIndex DynamoDB table to `template.yml`
  ...
  - [x] 9.2 Add Indexer Lambda function and execution role to `template.yml`
  ...
  - [x] 9.3 Add EventBridge schedule and parameters to `template.yml`
  ...
  - [x] 9.4 Add CloudWatch Alarm and SNS topic for Indexer Lambda errors
  ...
  - [x] 9.5 Update Read Lambda execution role and environment in `template.yml`
...
- [x] 10. Checkpoint — Verify infrastructure changes
  - Ensure all tests pass, ask the user if questions arise.

- [x] 11. Update Read Lambda to query DynamoDB index
  - [x] 11.1 Update `config/settings.js` to add `docIndexTable`
    - Add `docIndexTable: process.env.DOC_INDEX_TABLE || ''` to settings
    - _Requirements: 18.4_

  - [x] 11.2 Rewrite `models/doc-index.js` to query DynamoDB
  ...
  - [x] 11.3 Update `services/documentation.js` fetch function
  ...
  - [x] 11.4 Write unit tests for Read Lambda DynamoDB integration
...
- [x] 12. Create admin operations documentation
  - [x] 12.1 Create `docs/admin-ops/documentation-indexer.md`
