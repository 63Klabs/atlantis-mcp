 ...
 *
 * This is the doc-ai-common layer's copy of `nodejs/xray-capture.js`. Per design Option A
...
const HELPER_MODULE_PATH = '../../nodejs/xray-capture';
const XRAY_SDK_MODULE_NAME = 'aws-xray-sdk-core';

describe('captureClient() property tests (doc-ai-common layer)', () => {
