 ...
 *
 * This is the doc-indexer's copy of `lib/xray-capture.js`. Per design Option A
...
const HELPER_MODULE_PATH = '../../lib/xray-capture';
const XRAY_SDK_MODULE_NAME = 'aws-xray-sdk-core';

describe('captureClient() property tests (doc-indexer)', () => {
